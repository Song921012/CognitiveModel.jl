...
@time create_sysimage([:DifferentialEquations, :DiffEqFlux, :Plots, :DataFrames, :Optimization, :SciMLSensitivity], sysimage_path="JuliaSysimage.so", precompile_execution_file="./src/precompile.jl")